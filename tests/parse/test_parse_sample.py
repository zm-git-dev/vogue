...
def test_get_library_size_pre(lims, lims_sample):
    ...
    size = get_library_size(
        application_tag, lims_sample.id, lims, "SureSelect", "library_size_pre_hyb"
    )
...
def test_get_library_size_post(lims, lims_sample):
    ...
    size = get_library_size(
        application_tag, lims_sample.id, lims, "SureSelect", "library_size_post_hyb"
    )
