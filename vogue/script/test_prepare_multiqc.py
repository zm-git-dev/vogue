...
def test_extract_analysis():
    ...
    assert prepare_multiqc.extract_analysis(
        multiqc_dict=multiqc_dict, json_keys=multiqc_key, samples=sample
    )
    ...
    # WHEN reading the valid multiqc json file and extracting all results
    multiqc_dict = prepare_multiqc.read_multiqc(valid_multiqc)
    multiqc_dict = prepare_multiqc.extract_analysis(
        multiqc_dict=multiqc_dict, json_keys="all", samples=tuple()
    )
