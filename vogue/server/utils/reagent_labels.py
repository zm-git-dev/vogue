...
def reagent_category_data(adapter, index_category: str, flowcell_performance_treshold: float) -> dict:
    ...
    for data in aggregate_result:
        normalized_peformance = _build_normalized_index_performance_data(data, flowcell_performance_treshold)
...
def _build_normalized_index_performance_data(data: dict, flowcell_performance_treshold: float) -> list:
    ...
    for fc_performance, norm_performance, fc_id in ziped_data:
        if fc_performance > flowcell_performance_treshold:
